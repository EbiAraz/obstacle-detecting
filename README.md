...
Multiple dashboards (UI prototypes)— Control Centre, Driver HMI, Fleet Analytics, Maintenance dashboards built with Tailwind, Radix/shadcn components, Recharts, and Lucide icons.
